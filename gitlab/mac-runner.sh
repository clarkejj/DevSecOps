...
# This is mac-runner.sh from https://github.com/wilsonmar/DevSecOps/gitlab
...
# sh -c "$(curl -fsSL https://raw.githubusercontent.com/wilsonmar/DevSecOps/master/gitlab/mac-runner.sh)"
